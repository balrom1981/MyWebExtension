...
export declare class CommonComboBox extends React.Component<ICommonComboBoxProps, ICommonComboBoxState> {
    ...
    /** @internal */
    UNSAFE_componentWillReceiveProps(nextProps: ICommonComboBoxProps): void;
    /**
     ...
     */
    protected getElementByID: (id: string, disableFallbackToEmptyElement?: boolean, props?: ICommonComboBoxProps) => IComboBoxElement | null;
    /**
