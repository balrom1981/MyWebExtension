...
declare type PluginFunction = (art: ArtPlayerT) => any;
declare type WhitelistFunction = (ua: string) => boolean;
declare type CustomType = (video: HTMLVideoElement, url: string, art: ArtPlayerT) => any;
declare type EventCallback = (event: Event) => any;
declare type SubtitleOption = {
    /**
     * The subtitle url
     */
    url: string;
...
declare type AdsOption = {
    /**
     * The ads video url
     */
    url: string;
};
export declare type ArtPlayerOptionT = {
    /**
...
declare type AspectRatio = 'default' | '4:3' | '16:9' | void;
declare type PlaybackRate = 0.5 | 0.75 | 1.0 | 1.25 | 1.5 | 1.75 | 2.0 | void;
declare type Flip = 'normal' | 'horizontal' | 'vertical' | void;
...
export declare class ArtPlayerT extends Player {
    constructor(option: ArtPlayerOptionT);
    static instances: ArtPlayerT[];
    ...
    static html: string;
    static option: ArtPlayerT;
    readonly id: number;
    readonly option: ArtPlayerT;
    ...
    proxy(target: HTMLElement, name: string, callback: EventCallback, option?: {
        passive?: boolean;
        once?: boolean;
        capture?: boolean;
    } | boolean): Function;
    ...
    readonly hotkey: {
        add(key: number, callback: EventCallback): ArtPlayerT['hotkey'];
    };
    readonly plugins: {
        readonly id: number;
        add(plugin: PluginFunction): ArtPlayerT['plugins'];
    };
    readonly i18n: {
        readonly languages: {
            [key: string]: object;
