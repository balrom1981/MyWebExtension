import { MoveShortcutBatchOperationImpl, IMoveShortcutBatchOperationState } from "@docsvision/webclient/Platform/MoveShortcutBatchOperationImpl";
...
export declare class MoveShortcutBatchOperationParams extends BaseControlParams {
    ...
    buttonText?: string;
    services?: $LayoutInfo & $LayoutFolderController & $CardInfo & $LayoutCardController & $FolderDataLoading & $FolderGrid & $TableRowSelection & $CheckBoxServices & $BatchOperationsPerformer & $TableManagement & $TableMode & $BatchOperations & $CurrentFolder;
}
/**
 * Класс элемента управления GridDelegateOperation.
 */
export declare class MoveShortcutBatchOperation extends BaseControl<MoveShortcutBatchOperationParams, IMoveShortcutBatchOperationState> {
    /** @notest @internal */
