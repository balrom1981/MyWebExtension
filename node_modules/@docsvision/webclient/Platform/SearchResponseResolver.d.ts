...
export declare class SearchResponseResolver implements IFolderDataLoadingPlugin {
    id: string;
    description: string;
    order: PluginOrder;
    resolveResponse(data: ITableData, response: GenModels.GridViewModelEx, services: $WebFrameSearchPanel): Promise<void | ResponseResolveResult>;
}
