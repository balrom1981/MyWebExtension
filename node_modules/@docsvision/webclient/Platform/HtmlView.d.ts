...
/** @internal */
export interface IHtmlViewState extends HtmlViewParams, BaseControlState {
}
export interface HtmlViewState extends IHtmlViewState {
}
/**
 ...
 */
export declare class HtmlView extends BaseControl<HtmlViewParams, IHtmlViewState> {
    /** @internal */
    ...
    private set widthSetter(value);
    private set heightSetter(value);
    private set frameScrollingSetter(value);
    /** @internal */
