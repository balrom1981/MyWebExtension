 ...
 */
export declare abstract class BaseNavigationMainMenuItem<PropsT extends BaseNavigationMainMenuItemParams, StateT extends IBaseNavigationMainMenuItemState> extends BaseMainMenuItem<PropsT, StateT> {
    /** @internal */
    init(): void;
    /** @internal */
