...
export declare class ServerDefinedRouteHandler implements IRouteHandler<IServerDefinedRouteData> {
    ...
    name: string;
    prepareRouteDataLoad?(routeData: Partial<IServerDefinedRouteData>, routeType: RouteType): Promise<RouteHandleResult>;
    loadRouteData?(routeData: Partial<IServerDefinedRouteData>, routeType: RouteType): Promise<RouteHandleResult>;
    mountRoute?(routeData: IServerDefinedRouteData, routeType: RouteType): Promise<RouteHandleResult>;
