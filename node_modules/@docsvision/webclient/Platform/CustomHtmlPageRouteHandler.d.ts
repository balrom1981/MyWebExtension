...
export declare class CustomHtmlPageRouteHandler implements IRouteHandler<ICustomHtmlPageRouteData> {
    name: string;
    mountRoute(data: ICustomHtmlPageRouteData, routeType: RouteType): Promise<RouteHandleResult>;
    unmountRoute(data: ICustomHtmlPageRouteData, routeType: RouteType): Promise<{}>;
}
