...
export declare class DefaultFolderDataLoadingPluginFactory implements IFolderPluginFactory {
    id: string;
    getDataLoadingPlugins(folderInfo: ICommonFolderInfo, services: $CurrentLocation & $DeviceType & $ApplicationSettings): IFolderDataLoadingPlugin[];
}
