...
import { IBaseMainMenuItemState } from "@docsvision/webclient/Platform/BaseMainMenuItemImpl";
import { ConfigurableMainMenuContainerImpl, IConfigurableMainMenuContainerState } from "@docsvision/webclient/Platform/ConfigurableMainMenuContainerImpl";
 ...
 */
export declare class ConfigurableMainMenuContainer extends BaseMainMenuItem<ConfigurableMainMenuContainerParams, IConfigurableMainMenuContainerState> {
    protected construct(): void;
    /** @internal */
    protected createParams(): ConfigurableMainMenuContainerParams;
    /** @internal */
    protected set mainMenuSettings(val: GenModels.MainMenuSettings);
    /** @internal */
    protected set childrenHandler(val: GenModels.ControlModel[]);
    /**
    ...
    /** @internal */
    protected onControlConfigredToHide: (sender: BaseMainMenuItem<BaseMainMenuItemParams, IBaseMainMenuItemState>, configuredToHide: boolean) => void;
    /** @internal */
    protected saveSettings(settings: GenModels.MainMenuSettings): Promise<void>;
    /** @internal */
