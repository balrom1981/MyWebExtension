import { ChildTasksPerformingImpl, IState } from "@docsvision/webclient/BackOffice/ChildTasksPerformingImpl";
 ...
 */
export declare class ChildTasksPerforming extends BaseControl<Params, IState> {
    /** @internal */
    protected createParams(): Params;
    /** @internal */
    protected createImpl(): ChildTasksPerformingImpl;
    private set binding(value);
    private set commentBinding(value);
    private set commentFileBinding(value);
    private set dialogIsOpen(value);
    private get taskHasOwnCommentFile();
    ...
    copyAndCloseDialog(): Promise<void>;
