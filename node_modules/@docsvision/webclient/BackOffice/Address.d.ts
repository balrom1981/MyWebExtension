...
/**
 * Содержит публичные свойства элемента управления [Адрес]{@link Address}.
 */
export declare class AddressParams extends InputBasedControlParams<GenModels.AddressModel> {
