...
export interface ISimpleItemViewContentProps {
    ...
    onKeyDown?: (ev: React.KeyboardEvent<unknown>) => boolean;
    onDoubleClick?: (ev: React.MouseEvent<unknown>) => boolean;
...
export declare class SimpleItemViewContent extends React.Component<ISimpleItemViewContentProps, undefined> {
    ...
    protected onKeyDownDefault: (ev: React.KeyboardEvent<unknown>) => void;
    protected onKeyDown: (ev: any) => void;
    protected onClick: (ev: any) => void;
    protected onFocus: (ev: any) => void;
    protected onDoubleClickDefault: (ev: any) => void;
    protected onDoubleClick: (ev: any) => void;
    componentDidMount(): void;
    UNSAFE_componentWillReceiveProps(nextProps: ISimpleItemViewContentProps): void;
    render(): JSX.Element;
}
