...
export declare class DirectoryDesignerRowSelectDialog extends React.Component<IDirectoryDesignerRowSelectDialogProps, IDirectoryDesignerRowSelectDialogState> {
    ...
    get selectedDepartment(): DirectoryDesignerTreeNode;
    protected loadTree(parentNode?: ITreeNodeData, reloadTreeAfterSearch?: boolean): Promise<IDynamicTreeNodeData[]>;
    protected searchTree(searchText: string, resultNumber: number, searchMode?: GenModels.DirectoryDesignerSearchMode): Promise<GenModels.DirectoryDesignerSearchTreeResult>;
