...
export declare class AgreementManagementParams extends BaseControlParams {
    ...
    /** Сервисы. */
    services?: $LayoutAgreementController & $StaffDirectoryItemsController & $EditOperationStore & $MessageBox & $LayoutManager & $LayoutStaffController & $LayoutInfo & $Layout & $LocalStorage & $EmployeeController & $CardInfo & Optional<$AgreementOptions> & $LayoutRowController & $DeviceType;
}
/**
...
export declare class AgreementManagement extends BaseControl<AgreementManagementParams, AgreementManagementState> {
    ...
    private get stages();
    private get agreementExists();
    private get sidbarShown();
    private set agreementManagementData(value);
    private set agreementManagementOperationBinding(value);
    private set agreementStartOperationBinding(value);
    private set abortStageOperationBinding(value);
    private set agreementManagementButtonNames(value);
    private set availableButtons(value);
