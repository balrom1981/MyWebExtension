...
import { Service } from '@docsvision/web/core/services/Service';
import { IServiceContainer, ServiceContainerFluent, Factories, ServiceGetter, ServiceSetter } from '@docsvision/web/core/services/IServiceContainer';
/**
...
export declare class ServiceContainer implements IServiceContainer {
     ...
     */
    setService<T>(name: FieldSpec<any, T>, service: T): this;
    /**
     * Копирует информацию о сервисах в указанный контейнер.
     */
    copyTo(container: IServiceContainer): void;
    /**
