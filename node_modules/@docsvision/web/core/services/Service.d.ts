import { ServiceGetter, ServiceSetter, Factories } from '@docsvision/web/core/services';
...
export declare class Service<T = any> {
    ...
    get?: ServiceGetter<T>;
    set?: ServiceSetter<T>;
    constructor(name: string, meta: object);
    static GetServiceInstance<T>(service: Service<T>, container: any): T;
    static SetServiceInstance<T>(service: Service<T>, instance: T, container: any): void;
    /**
