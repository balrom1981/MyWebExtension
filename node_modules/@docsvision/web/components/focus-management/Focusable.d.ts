 ...
 *     </Focusable>
 */
export declare class Focusable extends React.Component<IFocusableProps, {}> {
    /** Узел Focusable */
    el?: HTMLElement;
    /** Элемент, имевший фокус до Focusable */
    prevFocusable?: HTMLElement;
    /** Родительский скрол-контейнер элемента, имевшего фокус до Focusable */
    prevFocusableScrollParent?: HTMLElement;
    /** Позиция скрола скрол-контейнера элемента, имевшего фокус до Focusable */
    prevFocusableScrollParentScrollTop?: number;
    ...
    /** Процент смещеня позиции скрола от видимого размера скрол-контейнера, при котором фокус не возвращается. */
    static readonly RETURN_FOCUS_SCROLL_TOLERANCE = 0.2;
    /** @internal */
    ...
    /** @internal */
    UNSAFE_componentWillReceiveProps(nextProps: IFocusableProps): void;
    /**
     ...
     * Режим Focusable
     */
    get mode(): IFocusableMode;
    /**
     * Ищет внутри себя элемент для передачи фокуса
     */
    protected findFocusable(): HTMLElement | undefined;
    /**
     * Находит текущий элемент с фокусом (нужно для возврата фокуса)
     */
    protected findCurrentFocusableElement(): Element;
    /**
