...
export declare class FocusTrapImpl {
    ...
    /** @internal */
    initialize(container: HTMLElement | undefined, reactComponent?: React.Component): void;
    /** @internal */
    deinitialize(): void;
     ...
     */
    protected focusEl: (el: HTMLElement | undefined) => void;
     ...
     */
    protected findFocusable(mode: 'first' | 'last'): HTMLElement | undefined;
    /**
    ...
    protected isKnownElement(elem: HTMLElement): boolean;
}
/**
...
export declare class FocusTrap extends React.Component<IFocusTrapProps, {}> {
    ...
    UNSAFE_componentWillReceiveProps(newProps: IFocusTrapProps): void;
    /** Получить контейнер. */
    protected getContainer: (props?: IFocusTrapProps) => HTMLElement | undefined;
    /** @internal */
    render(): JSX.Element;
}
