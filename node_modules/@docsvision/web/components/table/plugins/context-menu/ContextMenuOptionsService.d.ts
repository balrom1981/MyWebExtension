import { ContextMenuItemsManagementData, CustomMenuCompositions, CustomMenuEventTarget, IContextMenuOptionsService, ICustomContextMenuBlock, ICustomContextMenuOption, IDataItemProvider, IDataItemFilter, CustomMenuStateData, ContextMenuItemsManagementDataProvider, ContextMenuItemsManagementDataFilter } from '@docsvision/web/components/table/plugins/context-menu/$ContextMenuOptions';
...
export declare class ContextMenuOptionsService implements IContextMenuOptionsService {
    ...
    get $itemProviders(): Store<ContextMenuItemsManagementDataProvider>;
    get $itemFilters(): Store<ContextMenuItemsManagementDataFilter>;
